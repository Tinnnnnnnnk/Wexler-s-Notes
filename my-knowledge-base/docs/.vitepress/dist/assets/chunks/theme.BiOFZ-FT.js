const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.f0HCKXh3.js","assets/chunks/framework.BaarDA_E.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.f0HCKXh3.js"), true ? __vite__mapDeps([0,1]) : void 0));
...
const _hoisted_3$3 = {
  key: 1,
  class: "home-liquid-player-wrapper"
};
const _hoisted_4$2 = { class: "home-liquid-player__top" };
const _hoisted_5$2 = ["aria-label"];
const _hoisted_6$2 = { class: "home-liquid-player__transport" };
...
const _hoisted_10$2 = { class: "home-liquid-player__track" };
const _hoisted_11$1 = { class: "home-liquid-player__timeline" };
const _hoisted_12$1 = { class: "home-liquid-player__time" };
const _hoisted_13$1 = ["max", "value"];
const _hoisted_14$1 = { class: "home-liquid-player__time" };
const _hoisted_15$1 = { class: "home-liquid-player__volume" };
const _hoisted_16$1 = ["value"];
const _hoisted_17$1 = { class: "home-liquid-player__volume-value" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        isActive2.value ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass(["home-fx-layer", { "is-glass": isGlassActive.value, "is-liquid": isLiquidActive.value }]),
        ...
        isLiquidPlayerOnly.value ? (openBlock(), createElementBlock("div", _hoisted_3$3, [
          createBaseVNode("div", {
            ...
            createBaseVNode("div", _hoisted_4$2, [
              ...
              createBaseVNode("div", _hoisted_6$2, [
                ...
                createBaseVNode("button", {
                  ...
                  isPlaying.value ? (openBlock(), createElementBlock("span", _hoisted_8$2)) : (openBlock(), createElementBlock("span", _hoisted_9$2))
                ], 8, _hoisted_7$2),
                createBaseVNode("button", {
                  type: "button",
                  class: "home-liquid-player__ctrl",
            ...
            withDirectives(createBaseVNode("p", _hoisted_10$2, toDisplayString(LIQUID_BGM_TITLE) + " · " + toDisplayString(LIQUID_BGM_ARTIST), 512), [
              [vShow, !isMiniPlayer.value]
            ]),
            createBaseVNode("div", _hoisted_11$1, [
              createBaseVNode("span", _hoisted_12$1, toDisplayString(formatDuration(currentTime.value)), 1),
              ...
              createBaseVNode("span", _hoisted_14$1, toDisplayString(formatDuration(duration.value)), 1)
            ]),
            withDirectives(createBaseVNode("div", _hoisted_15$1, [
              createBaseVNode("span", {
                class: normalizeClass(["home-liquid-player__volume-icon", { "is-muted": isMuted.value }]),
                "aria-hidden": "true"
              }, null, 2),
              ...
              createBaseVNode("span", _hoisted_17$1, toDisplayString(volumePercent.value), 1)
            ], 512), [
              [vShow, isVolumePanelVisible.value && !isMiniPlayer.value]
            ])
          ], 2)
        ])) : createCommentVNode("", true),
        isLiquidPlayerOnly.value ? (openBlock(), createElementBlock("audio", {
          key: 2,
          ref_key: "bgmRef",
          ref: bgmRef,
          preload: "metadata",
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    function setDefault(event) {
      applyModeTransition(event, () => setFxMode("default"));
    }
    function toggleGlass(event) {
      applyModeTransition(event, () => toggleFxMode("glass"));
    }
    function toggleLiquid(event) {
      applyModeTransition(event, () => toggleFxMode("liquid"));
    }
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$6, [
          createBaseVNode("button", {
            type: "button",
            class: normalizeClass(["home-fx-toggle home-fx-toggle--default", { "is-active": unref(fxMode) === "default" }]),
          ...
          createBaseVNode("button", {
            type: "button",
            class: normalizeClass(["home-fx-toggle", { "is-active": unref(fxMode) === "glass" }]),
          ...
          createBaseVNode("button", {
            type: "button",
            class: normalizeClass(["home-fx-toggle home-fx-toggle--liquid", { "is-active": unref(fxMode) === "liquid" }]),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("button", {
          type: "button",
          class: normalizeClass(["home-layout-toggle home-layout-toggle--minimal", { "is-active": unref(layoutMode) === "minimal" }]),
          "aria-label": "Switch to Keynote layout",
          title: "Keynote / 发布会",
          onClick: _cache[0] || (_cache[0] = ($event) => applyMode("minimal"))
        }, [..._cache[3] || (_cache[3] = [
        ...
        createBaseVNode("button", {
          type: "button",
          class: normalizeClass(["home-layout-toggle home-layout-toggle--dashboard", { "is-active": unref(layoutMode) === "dashboard" }]),
          "aria-label": "Switch to Workbench layout",
          title: "Workbench / 工作台",
          onClick: _cache[1] || (_cache[1] = ($event) => applyMode("dashboard"))
        }, [..._cache[4] || (_cache[4] = [
          createBaseVNode("span", { class: "home-layout-toggle__dot" }, null, -1),
        ...
        createBaseVNode("button", {
          type: "button",
          class: normalizeClass(["home-layout-toggle home-layout-toggle--editorial", { "is-active": unref(layoutMode) === "editorial" }]),
          "aria-label": "Switch to Media layout",
          title: "Media / 媒体流",
          onClick: _cache[2] || (_cache[2] = ($event) => applyMode("editorial"))
        }, [..._cache[5] || (_cache[5] = [
          createBaseVNode("span", { class: "home-layout-toggle__dot" }, null, -1),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        !isLiquid.value ? (openBlock(), createElementBlock("section", {
          key: 0,
