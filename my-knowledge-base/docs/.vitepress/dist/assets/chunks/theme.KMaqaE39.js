const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.CbsiLNvW.js","assets/chunks/framework.BaarDA_E.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CbsiLNvW.js"), true ? __vite__mapDeps([0,1]) : void 0));
