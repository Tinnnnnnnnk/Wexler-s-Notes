const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.DfqZmYti.js","assets/chunks/framework.SODGKGda.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$q = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.DfqZmYti.js"), true ? __vite__mapDeps([0,1]) : void 0));
